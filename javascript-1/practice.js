...
// Create an object called 'me' that has these keys with the correct values: firstName, state, age, greeter. firstName will be your name as a string. state will be your current state or providence as a string. age will be your age as a number. greeter will be a method that returns the string 
...
// Using a for loop, loop over the passed in array in reverse and add each item to the new reversed array. Finally, 
...
const doubled = myNumbers.map(val => {
	return val * 2
})
...
// Code Here
const filtered = myNumbers.filter(val => {
	return val > 100;
})
...
const notGeorge = ['George', 'George', 'George', 'George', 'George', 'George']

// Code Here
const forTheLoveOfGeorge = notGeorge;
